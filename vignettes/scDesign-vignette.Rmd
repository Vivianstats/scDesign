---
title: "Introduction to scDesign"
...
output:
  html_document:
    df_print: paged
vignette: |
  %\VignetteIndexEntry{scDesign: a statistical simulator for rational scRNA-seq experimental design} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
---
